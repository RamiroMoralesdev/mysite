      ...
      <div className="max-w-4xl w-full">
        ...
        <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
          ...
          <div className="space-y-8">
            ...
            <img className="w-full" src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExaGw2djl1NDIwa2h2azB6MHlycjZkeWp6and5MzFtMnVzNHd2cmN3ZyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/jBOOXxSJfG8kqMxT11/giphy.gif" alt="" />
          </div>
        </div>
    </section>
  )
